...
public class DonHang implements Serializable{
    ...
    public DonHang(int id, float tongtien, NhaHang nhahang, Date thoigiandat, int trangthaidon, int tinhtrangnhandon, String diachigiaohang, NhanVienGiaoHang nhanviengiaohang, List<MonAnTrongDH> mondat) {
        this.id = id;
        this.tongtien = tongtien;
        this.nhahang = nhahang;
        this.thoigiandat = thoigiandat;
