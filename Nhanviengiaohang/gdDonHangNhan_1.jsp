                ...
                <table border="0">             
                    ...
                    <tr> <td> <table style="border: 1px solid black;border-collapse: collapse;" >
                                ...
                                <tr> <td> <table style="border: 1px solid black;border-collapse: collapse;" >
                                        ...
                                        <button type="button" name="Đã lấy đồ" onclick="setTrangThaiDaLayDo()">Đã lấy đồ</button>
                                        <button type="button" name="Đã giao hàng" onclick="setTrangThaiDaGiaoHang()">Đã giao hàng</button>
                                ...
                                <script type="text/javascript">
                                    ...
                                    function setTrangThaiDaLayDo() {
                                        if ((new DonHangDAO().setTrangThaiNhanDonHang(donhang.getId(),3))) {
                                            alert("Thành công!");
                                ...
                                <script type="text/javascript">
                                    ...
                                    function setTrangThaiDaGiaoHang() {
                                        if ((new DonHangDAO().setTrangThaiNhanDonHang(donhang.getId(),4))) {
                                            HoaDon hoadon = new HoaDon();
                                            hoadon.setDonHang(donhang);
                                            hoadon.setTienThanhToan(donhang.getTongTien());
                                          if ((new HoaDonDAO().luuDonHang(hoadon))){
                                              alert("Thành công!");}
                                          
                                          
                                            response.sendRedirect("gdChonDon.jsp");
                                        } else {
                                            alert("Lỗi");
                                            response.sendRedirect("gdDonHangNhan.jsp");
                                        }
